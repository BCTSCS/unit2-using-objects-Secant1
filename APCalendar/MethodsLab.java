...
public class MethodsLab {
    public static void main(String[] args) {
        ...
        System.out.println("=== New vs. Old Integer ===\n");
        valueVsNew();
    ...
    public static void parsing() {
        String str = "45.6";
        Double parsed = Double.valueOf(str);
 ...
 *  * 3. Create a method that counts all vowels in a string using indexOf()
